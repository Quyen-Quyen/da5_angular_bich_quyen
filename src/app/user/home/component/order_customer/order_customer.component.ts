...
@Component({
  selector: 'app-order_customer',
  templateUrl: './order_customer.component.html',
  styleUrls: ['./order_customer.component.css']
})
export class Order_customerComponent implements OnInit {
  order: any;
  status: number;
  order_detail: any;
  order_product: any;
